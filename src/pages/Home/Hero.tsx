...
import s from "../../assets/styles/css/Hero.module.css";
      ...
      <div className={s["hero-intro"]}>
        ...
        <div className={s["hero-intro__content"]}>
          <p>
            ...
            massa metus, aliquet non auctor vitae, ornare in libero. Integer a
            ultrices dolor. Praesent aliquet quam et felis pellentesque
            fermentum. Nulla quis odio non velit lobortis rhoncus.
          </p>
        </div>
